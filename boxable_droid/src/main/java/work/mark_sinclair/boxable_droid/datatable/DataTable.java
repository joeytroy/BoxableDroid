package work.mark_sinclair.boxable_droid.datatable;
...
import work.mark_sinclair.boxable_droid.BaseTable;
import work.mark_sinclair.boxable_droid.Cell;
import work.mark_sinclair.boxable_droid.HorizontalAlignment;
import work.mark_sinclair.boxable_droid.LineStyle;
import work.mark_sinclair.boxable_droid.Row;
import work.mark_sinclair.boxable_droid.Table;
import work.mark_sinclair.boxable_droid.VerticalAlignment;
...
public class DataTable {
	...
	private void setDefaultStyles() {
		...
		// Header style
		headerCellTemplate.setFillColor(Color.rgb(137, 218, 245));
		...
		defaultCellTemplate.setFillColor(Color.rgb(242, 242, 242));
