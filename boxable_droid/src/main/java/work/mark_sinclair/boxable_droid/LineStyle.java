...
public class LineStyle {
	 ...
	 *            The line width
	 */
	public LineStyle(final @ColorInt int color, final float width) {
		this.color = color;
		this.width = width;
	}
	 ...
	 */
	public static LineStyle produceDotted(final @ColorInt int color, final int width) {
	 ...
	 * @return new styled line
	 */
	public static LineStyle produceDashed(final @ColorInt int color, final int width) {
	 ...
	 * @return new styled line
	 */
	public static LineStyle produceDashed(final @ColorInt int color, final int width, final float[] dashArray,
